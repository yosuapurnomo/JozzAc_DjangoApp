...
class ClientModel(models.Model):
    ...
    kecamatan_Client	= models.CharField(max_length=30, null=True, blank=True, verbose_name='Kecamatan')
    kelurahan_Client	= models.CharField(max_length=30, null=True, blank=True, verbose_name='Kelurahan')
    kodePos_Client		= models.CharField(max_length=30, null=True, blank=True, verbose_name='Kode Pos')
